...
public class ListOfWebElements {
    ...
    public void test1() throws InterruptedException {
        ...
        //List<WebElement> menuList = driver.findElements(By.xpath("//li"));   //alt + enter tuşuna basıyoruz
        ...
        menuList.get(0).click();  //normalde bu şekilde klik yapılıyor ama bu siteden kaynaklı yapmıyor.
