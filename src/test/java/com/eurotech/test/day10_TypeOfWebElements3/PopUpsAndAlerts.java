...
public class PopUpsAndAlerts {
    ...
    public void PopUpHtml() throws InterruptedException {
        driver.get("https://www.primefaces.org/showcase/ui/overlay/confirmDialog.xhtml?jfwid=4b168");
    ...
    public void jsAlerts() throws InterruptedException {
        ...
        //click -> Click for JS(javascript) Alert Button
        driver.findElement(By.xpath("//button[text()='Click for JS Alert']")).click();

        //e.g. : 1 Switch to JS Alert popUp
        Alert alert = driver.switchTo().alert();   // Çıkan popUp javascript olduğu için 'incele' yapamıyoruz, bu
                                                    //yüzden burda Seleniumdan gelen Alert classına geçiş yapıyoruz.
        Thread.sleep(2000);
        //click to OK
        alert.accept();
